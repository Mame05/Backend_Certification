 ...
 * ),
 *     @OA\Parameter(in="path", name="sexe", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="path", name="date_naiss", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="path", name="profession", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="path", name="groupe_sanguin", required=false, @OA\Schema(type="string")
 * ),
 ...
 * @OA\GET(
 *     path="/api/profile",
 *     summary="Voir le profil d'un utilisateur simple",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 *     summary="Voir le profil d'une structure",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
